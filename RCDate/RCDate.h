...
//
// This is a general date class.  Dates represented internally as:
...
public:
	...
	{
		static string sdow[8] = { "Sunday", "Monday", "Tuesday", "Wednesday"
...
private:
	...
	// This only uses up a 4 byte int
	int m_date;

	// To fake value of today
